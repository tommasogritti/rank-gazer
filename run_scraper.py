...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Rank Gazer: App Store Ranking Scraper")
    parser.add_argument(
        "--app_url", type=str, help="URL of the app to scrape", required=True
    )
    args = parser.parse_args()

    data = scrape_data(args.app_url)
    append_to_csv(data)
